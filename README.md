...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-field-0e8f
```

A live public deployment of this template is available at [https://shy-field-0e8f.templates.workers.dev](https://shy-field-0e8f.templates.workers.dev)
